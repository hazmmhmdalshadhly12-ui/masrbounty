    ...
    <div className="py-2">
      <Card className="mx-auto w-full max-w-md text-center">
        <CardContent className="p-8">
          <h2 className="text-lg font-black">تعذر تحميل تقارير الشركة</h2>
          <p className="mt-2 text-sm text-muted-foreground">حدث عطل أثناء جلب التقارير الواردة. جرّب إعادة المحاولة.</p>
          {error.digest && (
